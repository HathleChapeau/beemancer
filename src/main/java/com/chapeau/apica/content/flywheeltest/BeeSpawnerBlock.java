 ...
 * | ApicaEntities   | Type entite test     | Spawn des test bees            |
 ...
 * ============================================================
 */
package com.chapeau.apica.content.flywheeltest;
...
public class BeeSpawnerBlock extends Block {
    ...
    private void spawnTestBees(Level level, BlockPos pos) {
        ...
        for (int i = 0; i < count; i++) {
            FlywheelTestBeeEntity bee = ApicaEntities.FLYWHEEL_TEST_BEE.get().create(level);
