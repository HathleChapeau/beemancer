...
public class CodexBookManager {
     ...
     * data/apica/codex/book/{nodeId}.json pour chacun.
    ...
    public static void load(ResourceManager resourceManager) {
        ...
        for (String nodeId : nodeIds) {
            ...
            if (resourceOpt.isPresent()) {
                try (InputStreamReader reader = new InputStreamReader(resourceOpt.get().open())) {
                    ...
                    Apica.LOGGER.info("Loaded book content for node: {} ({} sections)",
        ...
        loaded = true;
        Apica.LOGGER.info("CodexBook loaded: {} custom pages out of {} nodes",
