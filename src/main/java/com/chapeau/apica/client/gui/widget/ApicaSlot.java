...
public class ApicaSlot extends SlotItemHandler {
    @Nullable
     ...
     */
    public ApicaSlot(IItemHandler itemHandler, int index, int x, int y) {
     ...
     */
    public ApicaSlot(IItemHandler itemHandler, int index, int x, int y, ResourceLocation backgroundTexture) {
        super(itemHandler, index, x, y);
     ...
     */
    public ApicaSlot withFilter(Predicate<ItemStack> filter) {
        this.filter = filter;
        return this;
    }
     ...
     */
    public ApicaSlot withOnExtract(BiConsumer<net.minecraft.world.entity.player.Player, ItemStack> callback) {
    ...
    public ApicaSlot setActive(boolean active) {
        this.active = active;
        return this;
    }
     ...
     */
    public static ApicaSlot output(IItemHandler handler, int index, int x, int y) {
        return new ApicaSlot(handler, index, x, y).outputOnly();
    }

    /**
     * Factory method pour creer un slot d'output avec icone
     */
    public static ApicaSlot output(IItemHandler handler, int index, int x, int y, ResourceLocation icon) {
        return new ApicaSlot(handler, index, x, y, icon).outputOnly();
    }

    /**
     * Factory method pour creer un slot de bois (logs)
     */
    public static ApicaSlot woodInput(IItemHandler handler, int index, int x, int y) {
        return new ApicaSlot(handler, index, x, y,
            ResourceLocation.fromNamespaceAndPath("apica", "item/empty_slot_wood"));
    }
}
