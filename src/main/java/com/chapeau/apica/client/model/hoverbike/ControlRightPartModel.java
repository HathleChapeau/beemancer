...
public class ControlRightPartModel extends HoverbikePartModel {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = createLayerLocation("control_right");

    private static final ResourceLocation TEXTURE =
            ResourceLocation.fromNamespaceAndPath(Apica.MOD_ID, "textures/entity/hoverbee/hoverbee_control_right_a.png");

    public ControlRightPartModel(ModelPart root) {
        super(root);
    }
