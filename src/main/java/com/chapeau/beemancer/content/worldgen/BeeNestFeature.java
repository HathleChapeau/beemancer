 ...
 * | BeemancerBlocks          | Registre blocs         | Acces au bloc BEE_NEST         |
 * ------------------------------------------------------------
 *
 * UTILISE PAR:
 * - BeemancerFeatures.java (registration)
 * - Configured Feature JSON (reference)
 *
 * ============================================================
 */
package com.chapeau.beemancer.content.worldgen;
...
public class BeeNestFeature extends Feature<BeeNestFeatureConfig> {
    ...
    public boolean place(FeaturePlaceContext<BeeNestFeatureConfig> context) {
        ...
        BlockState nestState = BeemancerBlocks.BEE_NEST.get().defaultBlockState()
