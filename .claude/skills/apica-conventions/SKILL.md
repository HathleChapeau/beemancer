---
name: apica-conventions
description: Conventions et standards du projet Apica. Toujours appliquer pour tout nouveau code.
...
| Package | lowercase | `com.apica.content.hive` |
| Fichier registre | Apica[Type]s | `ApicaBlocks` |
...
- Pas de wildcard `*`
- Grouper par origine (minecraft, neoforge, apica)
...
- `ApicaConstants` — Constantes globales
- `ApicaTags` — Références aux tags
...
3. Adapter pour Apica (pas copier aveuglément)
