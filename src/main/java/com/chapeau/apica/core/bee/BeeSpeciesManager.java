 ...
 * ============================================================
 */
package com.chapeau.apica.core.bee;
 ...
 * Charge les donnees depuis data/apica/bees/bee_species.json et bee_stats.json
 */
public class BeeSpeciesManager {
    ...
    private static void invalidateGeneCaches() {
        try {
            var allGenes = com.chapeau.apica.core.gene.GeneRegistry.getAllGenes();
            int invalidated = 0;
            for (var gene : allGenes) {
                if (gene instanceof com.chapeau.apica.content.gene.species.DataDrivenSpeciesGene ddGene) {
