 ...
 *   "pedestal_items": [ { "item": "apica:honeyed_iron" }, ... ],
 *   "pollen": { "apica:common_pollen": 4 },
 *   "result": { "id": "apica:codex" }
 * }
 *
 * ============================================================
 */
...
public record AltarRecipe(
    ...
    public RecipeSerializer<?> getSerializer() {
        return ApicaRecipeSerializers.ALTAR.get();
    }

    @Override
    public RecipeType<?> getType() {
        return ApicaRecipeTypes.ALTAR.get();
    }
