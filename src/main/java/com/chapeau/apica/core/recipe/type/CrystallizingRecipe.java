 ...
 * FORMAT JSON:
 * {
 *   "type": "apica:crystallizing",
 *   "fluid_ingredient": { "fluid": "apica:honey", "amount": 500 },
 *   "result": { "item": "apica:honey_crystal" },
 *   "processing_time": 100
 * }
 *
 * ============================================================
...
public record CrystallizingRecipe(
    ...
    public RecipeSerializer<?> getSerializer() {
        return ApicaRecipeSerializers.CRYSTALLIZING.get();
    }

    @Override
    public RecipeType<?> getType() {
        return ApicaRecipeTypes.CRYSTALLIZING.get();
    }
