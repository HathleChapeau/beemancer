...
public final class FluidCubeRenderer {
    ...
    /**
     * Rend un cube de fluide avec les 6 faces à normales inversées (double-sided rendering).
     * Les vertices sont émis dans l'ordre inverse pour que les faces soient visibles depuis l'intérieur.
     */
    public static void renderFluidCubeInverted(VertexConsumer consumer, PoseStack.Pose pose, TextureAtlasSprite sprite,
                                                float minX, float minY, float minZ,
                                                float maxX, float maxY, float maxZ) {
