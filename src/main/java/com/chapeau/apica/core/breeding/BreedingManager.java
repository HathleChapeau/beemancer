 ...
 * ============================================================
 */
package com.chapeau.apica.core.breeding;
...
public class BreedingManager {
    ...
    public static void loadCombinations(MinecraftServer server) {
        ...
        ResourceLocation location = ResourceLocation.fromNamespaceAndPath(Apica.MOD_ID, "breeding/species_combinations.json");
