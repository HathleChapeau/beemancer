 ...
 * FORMAT JSON:
 * {
 *   "type": "apica:centrifuging",
 *   "ingredient": { "item": "apica:cupric_comb" },
 *   "results": [
 *     { "item": { "id": "apica:raw_copper_shard" }, "chance": 0.8 }
 *   ],
 *   "fluid_result": { "fluid": "apica:honey", "amount": 250 },
 *   "processing_time": 60
 * }
 *
 * ============================================================
 */
package com.chapeau.apica.core.recipe.type;
...
public record CentrifugeRecipe(
    ...
    public RecipeSerializer<?> getSerializer() {
        return ApicaRecipeSerializers.CENTRIFUGING.get();
    }

    @Override
    public RecipeType<?> getType() {
        return ApicaRecipeTypes.CENTRIFUGING.get();
    }
