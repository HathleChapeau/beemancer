 ...
 * ============================================================
 * [ApicaFluids.java]
 * Description: Registre des fluides Apica (NeoForge 1.21.1)
 * ============================================================
 */
package com.chapeau.apica.core.registry;

import com.chapeau.apica.Apica;
import com.chapeau.apica.common.fluid.HoneyFluid;
...
public class ApicaFluids {
    public static final DeferredRegister<Fluid> FLUIDS =
        DeferredRegister.create(Registries.FLUID, Apica.MOD_ID);
    
    public static final DeferredRegister<FluidType> FLUID_TYPES =
        DeferredRegister.create(NeoForgeRegistries.FLUID_TYPES, Apica.MOD_ID);
    ...
    public static final Supplier<FluidType> HONEY_FLUID_TYPE = FLUID_TYPES.register("honey",
        () -> new FluidType(FluidType.Properties.create()
            ...
            .descriptionId("fluid.apica.honey")));
    ...
    public static final Supplier<FluidType> ROYAL_JELLY_FLUID_TYPE = FLUID_TYPES.register("royal_jelly",
        () -> new FluidType(FluidType.Properties.create()
            ...
            .descriptionId("fluid.apica.royal_jelly")));
    ...
    public static final Supplier<FluidType> NECTAR_FLUID_TYPE = FLUID_TYPES.register("nectar",
        () -> new FluidType(FluidType.Properties.create()
            ...
            .descriptionId("fluid.apica.nectar")));
