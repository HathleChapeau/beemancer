/**
 * ============================================================
 * [NectarFilterScreen.java]
 * Description: GUI pour le filtre à nectar
 * ============================================================
 */
...
public class NectarFilterScreen extends AbstractContainerScreen<NectarFilterMenu> {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(
            Beemancer.MOD_ID, "textures/gui/nectar_filter.png");

    public NectarFilterScreen(NectarFilterMenu menu, Inventory playerInventory, Component title) {
