 ...
 * Description: Registre des fluides Beemancer (Honey, Royal Jelly, Nectar, Elemental Nectars)
 * ============================================================
 */
            ...
            public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer) {
                consumer.accept(new IClientFluidTypeExtensions() {
                    ...
                    public ResourceLocation getStillTexture() {
                        return ResourceLocation.fromNamespaceAndPath(Beemancer.MOD_ID, "block/fluid/honey_still");
                    }
                    @Override
                    public ResourceLocation getFlowingTexture() {
                        return ResourceLocation.fromNamespaceAndPath(Beemancer.MOD_ID, "block/fluid/honey_flow");
                    }
                    @Override
                    public int getTintColor() { return 0xFFEB9B3B; }
                });
            }
        });
        ...
        () -> new FluidType(FluidType.Properties.create()
            ...
            public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer) {
                consumer.accept(new IClientFluidTypeExtensions() {
                    @Override
                    public ResourceLocation getStillTexture() {
                        return ResourceLocation.fromNamespaceAndPath(Beemancer.MOD_ID, "block/fluid/royal_jelly_still");
                    }
                    @Override
                    public ResourceLocation getFlowingTexture() {
                        return ResourceLocation.fromNamespaceAndPath(Beemancer.MOD_ID, "block/fluid/royal_jelly_flow");
                    }
                    @Override
                    public int getTintColor() { return 0xFFE8A0D0; }
                });
            }
        });

    public static final Supplier<FlowingFluid> ROYAL_JELLY_SOURCE = FLUIDS.register("royal_jelly",
        () -> new HoneyFluid.RoyalJellySource());
    public static final Supplier<FlowingFluid> ROYAL_JELLY_FLOWING = FLUIDS.register("royal_jelly_flowing",
        () -> new HoneyFluid.RoyalJellyFlowing());
        ...
        () -> new FluidType(FluidType.Properties.create()
            ...
            public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer) {
                consumer.accept(new IClientFluidTypeExtensions() {
                    @Override
                    public ResourceLocation getStillTexture() {
                        return ResourceLocation.fromNamespaceAndPath(Beemancer.MOD_ID, "block/fluid/nectar_still");
                    }
                    @Override
                    public ResourceLocation getFlowingTexture() {
                        return ResourceLocation.fromNamespaceAndPath(Beemancer.MOD_ID, "block/fluid/nectar_flow");
                    }
                    @Override
                    public int getTintColor() { return 0xFFB388DD; }
                });
            }
        });

    public static final Supplier<FlowingFluid> NECTAR_SOURCE = FLUIDS.register("nectar",
        () -> new HoneyFluid.NectarSource());
    public static final Supplier<FlowingFluid> NECTAR_FLOWING = FLUIDS.register("nectar_flowing",
        () -> new HoneyFluid.NectarFlowing());
        ...
        () -> new FluidType(FluidType.Properties.create()
            ...
            public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer) {
                consumer.accept(new IClientFluidTypeExtensions() {
                    @Override
                    public ResourceLocation getStillTexture() {
                        return ResourceLocation.fromNamespaceAndPath(Beemancer.MOD_ID, "block/fluid/fire_nectar_still");
                    }
                    @Override
                    public ResourceLocation getFlowingTexture() {
                        return ResourceLocation.fromNamespaceAndPath(Beemancer.MOD_ID, "block/fluid/fire_nectar_flow");
                    }
                    @Override
                    public int getTintColor() { return 0xFFFF6600; }
                });
            }
        });

    public static final Supplier<FlowingFluid> FIRE_NECTAR_SOURCE = FLUIDS.register("fire_nectar",
        () -> new HoneyFluid.FireNectarSource());
    public static final Supplier<FlowingFluid> FIRE_NECTAR_FLOWING = FLUIDS.register("fire_nectar_flowing",
        () -> new HoneyFluid.FireNectarFlowing());
        ...
        () -> new FluidType(FluidType.Properties.create()
            ...
            public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer) {
                consumer.accept(new IClientFluidTypeExtensions() {
                    @Override
                    public ResourceLocation getStillTexture() {
                        return ResourceLocation.fromNamespaceAndPath(Beemancer.MOD_ID, "block/fluid/frost_nectar_still");
                    }
                    @Override
                    public ResourceLocation getFlowingTexture() {
                        return ResourceLocation.fromNamespaceAndPath(Beemancer.MOD_ID, "block/fluid/frost_nectar_flow");
                    }
                    @Override
                    public int getTintColor() { return 0xFF88DDFF; }
                });
            }
        });

    public static final Supplier<FlowingFluid> FROST_NECTAR_SOURCE = FLUIDS.register("frost_nectar",
        () -> new HoneyFluid.FrostNectarSource());
    public static final Supplier<FlowingFluid> FROST_NECTAR_FLOWING = FLUIDS.register("frost_nectar_flowing",
        () -> new HoneyFluid.FrostNectarFlowing());
        ...
        () -> new FluidType(FluidType.Properties.create()
            ...
            public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer) {
                consumer.accept(new IClientFluidTypeExtensions() {
                    @Override
                    public ResourceLocation getStillTexture() {
                        return ResourceLocation.fromNamespaceAndPath(Beemancer.MOD_ID, "block/fluid/storm_nectar_still");
                    }
                    @Override
                    public ResourceLocation getFlowingTexture() {
                        return ResourceLocation.fromNamespaceAndPath(Beemancer.MOD_ID, "block/fluid/storm_nectar_flow");
                    }
                    @Override
                    public int getTintColor() { return 0xFFFFFF00; }
                });
            }
        });

    public static final Supplier<FlowingFluid> STORM_NECTAR_SOURCE = FLUIDS.register("storm_nectar",
        () -> new HoneyFluid.StormNectarSource());
    public static final Supplier<FlowingFluid> STORM_NECTAR_FLOWING = FLUIDS.register("storm_nectar_flowing",
        () -> new HoneyFluid.StormNectarFlowing());
