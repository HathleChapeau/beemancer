 ...
 * | Apica           | MOD_ID               | Construction ModelLayerLocation|
 * ------------------------------------------------------------
 *
 * UTILISE PAR:
...
public abstract class HoverbikePartModel extends HierarchicalModel<HoverbikeEntity> {
     ...
     * Convention: apica:hoverbike_[partName] / main
     */
    public static ModelLayerLocation createLayerLocation(String partName) {
        return new ModelLayerLocation(
                ResourceLocation.fromNamespaceAndPath(Apica.MOD_ID, "hoverbike_" + partName),
                "main"
        );
    }
}
