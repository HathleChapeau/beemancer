/**
 * ============================================================
 * [CompanionBeeRenderLayer.java]
 * Description: RenderLayer multi-pass tinte pour CompanionBeeEntity via ApicaBeeModel
 * ============================================================
 *
 * DEPENDANCES:
 * ------------------------------------------------------------
 ...
 * |---------------------|----------------------|--------------------------------|
 * | CompanionBeeRenderer| Renderer parent      | Acces donnees espece courante  |
 * | ApicaBeeModel       | Modele modulaire     | Rendu multi-pass par partie    |
 * | BeeSpeciesManager   | Donnees especes      | Couleurs par partie            |
 * ------------------------------------------------------------
 *
 * UTILISE PAR:
 * - CompanionBeeRenderer.java: Ajout comme layer de rendu
 *
 * ============================================================
 */
...
/**
 * Layer de rendu multi-pass pour les abeilles compagnon.
 ...
 *
 * Utilise les couleurs de BeeSpeciesManager basees sur l'espece du compagnon.
 */
public class CompanionBeeRenderLayer extends RenderLayer<CompanionBeeEntity, ApicaBeeModel<CompanionBeeEntity>> {

    private final CompanionBeeRenderer parentRenderer;

    public CompanionBeeRenderLayer(CompanionBeeRenderer renderer) {
        super(renderer);
    ...
    public void render(PoseStack poseStack, MultiBufferSource buffer, int packedLight,
                       CompanionBeeEntity bee, float limbSwing, float limbSwingAmount,
                       float partialTick, float ageInTicks, float netHeadYaw, float headPitch) {

        ApicaBeeModel<CompanionBeeEntity> model = getParentModel();
