 ...
 * ============================================================
 */
package com.chapeau.apica.core.behavior;
 ...
 * Charge les donnees depuis data/apica/behavior/species_behaviors.json
 */
public class BeeBehaviorManager {
    ...
    private static final ResourceLocation CONFIG_PATH = ResourceLocation.fromNamespaceAndPath(
            Apica.MOD_ID, "behavior/species_behaviors.json");
