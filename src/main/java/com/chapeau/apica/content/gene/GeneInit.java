 ...
 * ============================================================
 */
package com.chapeau.apica.content.gene;

import com.chapeau.apica.Apica;
import com.chapeau.apica.content.gene.environment.NocturnalEnvironmentGene;
import com.chapeau.apica.content.gene.environment.NormalEnvironmentGene;
import com.chapeau.apica.content.gene.environment.RobustEnvironmentGene;
import com.chapeau.apica.content.gene.flower.CavePlantsFlowerGene;
import com.chapeau.apica.content.gene.flower.CropsFlowerGene;
import com.chapeau.apica.content.gene.flower.CrystalsFlowerGene;
import com.chapeau.apica.content.gene.flower.FlowersFlowerGene;
import com.chapeau.apica.content.gene.flower.MushroomsFlowerGene;
import com.chapeau.apica.content.gene.flower.NetherWartFlowerGene;
import com.chapeau.apica.content.gene.flower.TreesFlowerGene;
...
public class GeneInit {
    ...
    public static void registerAllGenes() {
        if (initialized) {
            Apica.LOGGER.warn("GeneInit.registerAllGenes() called multiple times");
            return;
        }
        ...
        initialized = true;
        Apica.LOGGER.info("Registered {} species genes", ALL_SPECIES.size());
    }
