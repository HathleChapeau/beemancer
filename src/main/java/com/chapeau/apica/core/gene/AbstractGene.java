 ...
 * ============================================================
 */
package com.chapeau.apica.core.gene;
...
public abstract class AbstractGene implements Gene {
    ...
    public Component getDisplayName() {
        return Component.translatable("gene.apica." + category.getId() + "." + id);
    }

    @Override
    public Component getDescription() {
        return Component.translatable("gene.apica." + category.getId() + "." + id + ".desc");
    }
